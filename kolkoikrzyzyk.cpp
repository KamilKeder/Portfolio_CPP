...
void Kolkoikrzyzyk::kolkoikrzyzyk_menu() {
    system("cls");
    void kolkoikrzyzyk_plansza(int wynik_gracza, int wynik_komputera);
    int AktualnyRuch = 1, WynikGracz = 0, WynikKomputer = 0;;
    string p1 = "1", p2 = "2", p3 = "3", p4 = "4", p5 = "5", p6 = "6", p7 = "7", p8 = "8", p9 = "9";
    kolkoikrzyzyk_plansza(WynikGracz, WynikKomputer);

}
void Kolkoikrzyzyk::kolkoikrzyzyk_plansza(int wynik_gracza, int wynik_komputera) {
    system("cls");
    void menu(), ruch_gracza();
    cout << "Wpisz 0 aby wyjsc z aplikacji." << endl << endl;
    cout << "Gra kolko i krzyzyk" << endl;
    cout << "Gracz: " << wynik_gracza << " Komputer: " << wynik_komputera << endl;
    cout << "Plansza" << endl;
    cout << "     |     |     " << endl;
    cout << "  " << p7 << "  |  " << p8 << "  |  " << p9 << endl;
...
void Kolkoikrzyzyk::ruch_gracza() {
    if (WyborGracza == p1) {
        p1 = "O";
    }
...
void Kolkoikrzyzyk::sprawdzenie() {
    if (p7 == "O" && p8 == "O" && p9 == "O" ||
        p7 == "O" && p5 == "O" && p3 == "O" ||
        p7 == "O" && p4 == "O" && p1 == "O" ||
        p8 == "O" && p5 == "O" && p2 == "O" ||
...
void Kolkoikrzyzyk::ruch_komputera{
     int i = (rand() % 9 + 1);
